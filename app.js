...
function adminShell(v){const items=[{id:"admin-dashboard",label:"캠페인 관리",icon:"clipboard-list"},{id:"admin-todo",label:"해야 할 일",icon:"list-todo"},{id:"admin-workflow",label:"워크플로우 관리",icon:"list-checks"},{id:"admin-calendar",label:"캠페인 일정",icon:"calendar"},{id:"admin-members",label:"회원DB",icon:"users"},{id:"admin-channels",label:"채널 DB",icon:"layers"}];let b=v==="admin-members"?viewAdminMembers():v==="admin-channels"?viewAdminChannels():v==="admin-workflow"?viewAdminWorkflow():v==="admin-calendar"?viewAdminCalendar():v==="admin-todo"?viewTodo():viewAdminList();
